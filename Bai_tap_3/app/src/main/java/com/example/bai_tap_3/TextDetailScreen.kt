    ...
    ConstraintLayout(
        ...
        Text(
            text = buildAnnotatedString {
                ...
                withStyle(style = SpanStyle(textDecoration = TextDecoration.LineThrough,color = Color.Black)) { append("quick ") }
                withStyle(style = SpanStyle(color = Color(0xFFF44336))) { append("Brown") }
                append("\n")
                withStyle(style = SpanStyle(color = Color.Black)) {
                    append("fox")
                }
                withStyle(style = SpanStyle(letterSpacing = 3.sp,color = Color.Black)) {
                    append(" jumps ")
                }
                ...
                append("\n")
                withStyle(style = SpanStyle(textDecoration = TextDecoration.Underline,color = Color.Black)) {
                    append("the")
                }
                withStyle(style = SpanStyle(fontStyle = FontStyle.Italic,color = Color.Black)) {
                    append(" lazy ")
                }
                withStyle(style = SpanStyle(color = Color.Black)) {
                    append("dog.")
